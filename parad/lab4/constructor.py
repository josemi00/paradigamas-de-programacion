...
class Computadora:
    ...
    def imprimirInfoPC(self):
        print(f"Esta es la computadora marca: {self.marca} con almacenamiento de {self.capacidad}GB y memoria{self.ram}GB")
...
class Persona:
    ...
    def imprimirInfo(self) -> None:
        print(f"--- Mi nombre es {self.nombres} {self.apellidos}, tengo {self.edad} anos de edad, vivo {self.direccion} ")
...
#===========================================
def funcion1():
    persona = Persona("Carlos", "Perez", 40, "Iztapalapa", "Lenovo",700,8)
    print("\n")
